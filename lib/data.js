// ---------------------------------------------------------------------------
// SWAP POINT
// Everything in this file is synthetic seed data used by the dashboard.
// To go live against the Dell box, replace each export with a fetch() to the
// backend API. Component code never imports anything else, so nothing else
// has to change.
//   getPrescriptions()  ->  GET /api/tables/prescriptions
